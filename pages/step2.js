      ...
      <PageAnimationWrapper>
        ...
        >
          <FormWrapper>
            ...
            <div className="p-6">
              <h1 className="text-xl font-semibold text-center mb-2 text-black">Residential Address</h1>
              <p className="text-sm text-black text-center mb-6">Require for age verification purpose</p>
