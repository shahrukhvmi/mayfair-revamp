  ...
  return (
    <>
      ...
      <PageAnimationWrapper>
        <div
          className={`${inter.className} min-h-screen flex items-center justify-center bg-[#FAFAF0] px-4 sm:px-6 lg:px-8 ${
        ...
        >
          <FormWrapper width="my-20">
            ...
            <h1 className="text-2xl font-inter text-center mb-2 text-black">Medical Questions</h1>
