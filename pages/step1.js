      ...
      <PageAnimationWrapper>
        ...
        >
          <FormWrapper>
            ...
            <div className="p-6">
              <h1 className="text-xl font-semibold text-center mb-2 text-black">What is your date of birth?</h1>
              <p className="text-sm text-green-900 text-center mb-6">Please ensure that this matches your ID.</p>
