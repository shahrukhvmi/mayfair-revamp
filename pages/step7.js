    ...
    return (
        <>
            <PageAnimationWrapper>
                <FormWrapper
                    heading="Have we got this right?"
                    description=""
                    percentage={75}
                >
                    <div className="p-6 space-y-6">
                        ...
                        <div className="bg-green-50 border border-green-100 rounded-md p-5 text-sm text-gray-800">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-2 gap-x-8">
                                ...
                                <p><span className="font-semibold">Height:</span> 125 cm</p>
                                <p><span className="font-semibold">Sex at birth:</span> Male</p>
                                <p><span className="font-semibold">Weight:</span> 78 kg</p>
                                <p className="sm:col-span-2"><span className="font-semibold">Ethnicity:</span> Aboriginal or Torres Strait Islander</p>
                            </div>
                        </div>
