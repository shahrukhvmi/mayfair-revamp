  ...
  return (
    <div className="mb-4">
      ...
      <input
        ...
        {...fieldProps}
        onBlur={onBlur}
        className={`inter-reg-font w-full border-0 border-b-2 bg-transparent px-0 py-3 text-[15px] text-slate-900 placeholder:text-slate-300 focus:outline-none transition-colors duration-200
          ${errors[name] ? "border-red-400" : "border-slate-200 focus:border-[#47317c]"}
