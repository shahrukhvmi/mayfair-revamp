        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center justify-center w-5 h-5">
            {isSelected ? (
              ...
              <FaRegCircle className="text-gray-800 w-5 h-5" />
            )}
          </div>

          {/* Text */}
          <div className="flex flex-col">
            <span className={`reg-font text-sm sm:text-base text-black ${isSelected ? "text-violet-700" : "text-gray-800"}`}>
              <span className="capitalize bold-font">{addon?.mediName} </span>
