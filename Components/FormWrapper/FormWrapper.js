...
const FormWrapper = ({
  ...
  return (
    <>
      <StepsHeader />
      <div
        className={`${inter.className} min-h-screen flex items-center justify-center bg-gray-50 p-4 sm:p-6 ${
      ...
      >
        <div className={`bg-white rounded-xl shadow-md w-full max-w-md ${width}`}>
          ...
          <div className="px-6 pt-6 pb-8">
            {/* Title */}
            <h1 className="text-xl font-semibold text-center mb-2 text-gray-900">
              {heading}
            </h1>
