...
`}
    ...
    >
        <div className="absolute inset-0 bg-gradient-to-b from-[#47317c]/22 via-[#47317c]/8 to-white/40 pointer-events-none" />
        ...
        ${tone === "green"
                            ...
                            : tone === "red"
                                ...
                                : "bg-white/60 text-[#47317c] border-white/70"
                        }`}
                >
                    <CheckCircle size={16} />
                    {badge}
...
const ChartCard = ({ title, children }) => (
    <div className="relative bg-white/70 backdrop-blur-xl border border-white/60 shadow-[0_30px_70px_rgba(15,23,42,0.14)] p-6">
        <div className="absolute inset-0 bg-gradient-to-t from-[#47317c]/18 via-[#47317c]/6 to-white/50 pointer-events-none" />
